...
moveStackToFront(d);
//console.log("Dans le sun", program_filter);
//
...
function moveStackToFrontUniv(elD) {
   ...
   function makeTable() {
        ...
        $(document).ready(function() {
            ...
            var rows3 = [];  // Global rows for #example2
    ...
    function handleDragStart(e) {
      ...
      function handleDrop(e) {
        ...
        if (srcTable !== dstTable) {
          ...
          console.log($(srcData))
          console.log(dstRow)
          if(dragSrcRow ===srcData){
              console.log('cc')
          }
          //console.log($(dragSrcRow)[0].innerHTML)
          $('#' + dstTable).DataTable().rows().data().each(function(d){ 
              //console.log($(d))
            //console.log($(this)[i])
            //console.log('d',$(d)[0].innerHTML)
              /* if($(this)[i]!==d){
                  console.log('ok')
              } */
          })
